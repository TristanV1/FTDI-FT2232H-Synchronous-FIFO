...
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { data[4]  }]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { data[5]  }]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports { data[6]  }]; #IO_L6N_T0_VREF_16 Sch=pio[07]
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports { data[7]  }]; #IO_L11N_T1_SRCC_16 Sch=pio[08]
...
set_property -dict { PACKAGE_PIN M1    IOSTANDARD LVCMOS33 } [get_ports { rxf_n }]; #IO_L9N_T1_DQS_AD7N_35 Sch=pio[17]
set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports { txe_n }]; #IO_L12P_T1_MRCC_35 Sch=pio[18]
...
set_property -dict { PACKAGE_PIN N1    IOSTANDARD LVCMOS33 } [get_ports { rd_n }]; #IO_L10N_T1_AD15N_35 Sch=pio[21]
set_property -dict { PACKAGE_PIN N2    IOSTANDARD LVCMOS33 } [get_ports { wr_n }]; #IO_L10P_T1_AD15P_35 Sch=pio[22]
...
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { oe_n }]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { siwu }]; #IO_L14N_T2_SRCC_34 Sch=pio[48]
